...
La France est aujourd’hui confrontée à un double paradoxe. D’une part, notre pays est bien positionné sur le sujet : il peut s’appuyer sur un tissu de recherche de tout premier plan, comme le confirment l’INRIA et les chaires DeepTech de l’ANR, sur une communauté de startups florissante qui compte aujourd’hui des licornes et des pépites de la tech comme Mistral AI ou Hugging Face, et sur une place de leader en Europe concernant la régulation et la gouvernance de l’IA avec l’IA Act.
\\\\
