...
L'étude de terrain conduite auprès de 63 prospects associée à l'analyse de 5 offres commerciales Luwai met en lumière un paysage tortueux des freins et des leviers en faveur de l'adoption de l'IA au sein des PME et ETI françaises. Cette partie restitue cette enquête terrain, dansant autour de 4 temps : des conditions de la collecte, du recensement des freins, de l'analyse des leviers puis des profils adoptants. Le parti pris de cette recherche est l'immersion entrepreneuriale mêlée à une exigence scientifique forte, gage d'une lumière différente sur les réalités d'adoption souvent méconnues des études classiques \cite{yin2018case}.

\section{Méthodologie de Recherche Terrain}

\subsection{Cadre de Collecte et Échantillonnage}

La collecte de données primaires a été réalisée entre juin et août 2025, période pendant laquelle les outils d’IA générative (ChatGPT, Copilot, Claude) trouvaient leur maturité, mais restaient néanmoins peu adoptés par les PME-ETI françaises \cite{bpifrance2025ia}. Cette période est particulièrement importante pour étudier les processus d’adoption en direct, avant que les usages ne se figent  ou qu’ils ne soient influencés par des phénomènes de mode \cite{rogers2003diffusion}.
\\\\
...
\end{itemize}
\medskip
\textbf{Méthodologie de prospection et qualification} : La méthode adoptée repose sur un \emph{cold calling} systématique, dont la pertinence est ensuite évaluée selon un protocole formalisé. Sur 63 personnes contactées, 13 rendez-vous ont été obtenus, soit un \textbf{taux de transformation de 20,6\%}. Ce résultat s’explique par plusieurs éléments : un \emph{timing} favorable (montée en puissance de l’IA générative), un positionnement différencié(\enquote{accompagnement} vs \enquote{vente d’outils}), et une pré-qualification des secteurs d’activité privilégiant les services intellectuels \cite{kotler2017marketing}.
\\\\
